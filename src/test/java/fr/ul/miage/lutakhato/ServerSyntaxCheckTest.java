...
public class ServerSyntaxCheckTest {
    ...
    public void testGoodSyntaxSet(String entry) {
        assertTrue((new ServerThread(client)).syntaxCheckMethods(entry));
    }
    ...
    public void testBadSyntaxSet(String entry) {
        assertFalse((new ServerThread(client)).syntaxCheckMethods(entry));
    }
    ...
    public void testBadSyntaxEmptyArgument() {
        assertAll(
                () -> assertFalse((new ServerThread(client)).syntaxCheckMethods("")),
                () -> assertFalse((new ServerThread(client)).syntaxCheckMethods(" ")),
                () -> assertFalse((new ServerThread(client)).syntaxCheckMethods("             "))
        );
    }
